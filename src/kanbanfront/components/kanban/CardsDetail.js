        ...
        <div style={typeStyle.detailStyle}>
          ...
          <div style={{marginTop:'40px'}}>
            ...
            <h3 style={{marginBottom:'20px',marginLeft:10,height:20,width:'100%'}} onClick={this.handleClick}>
              ...
              <Input id='input1' style={{display:this.state.mark?'none':'block',width:580}}  onPressEnter={this.handleBlur} onBlur={this.handleBlur} onChange={this.handleChange} defaultValue={Issue.description} />
              </h3>
            <p style={{fontSize:'12px'}}><span style={{marginRight:'30px',marginLeft:10}}>{this.getCreater(Issue.acception)}</span>
                ...
                <Row gutter={8}>
                  ...
                  <Col span={8}>
                    <FormItem {...formItemLayout} label="故事点">
                      ...
                      (<InputNumber style={{width:100}} onBlur={this.onChangeStatus} className="inputNum"/>)}
                    </FormItem>
                  </Col>
                  <Col span={8}>
