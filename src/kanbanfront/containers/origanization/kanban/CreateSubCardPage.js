...
@observer
class CreateSubCardPage extends Component {
  constructor(props) {
    super(props);
    ...
    this.state={
      ...
      startTime:-28800000,
      endTime:-28800000,
      id:this.props.match.params.parentCardId
    }
  }
  componentWillMount(){
  ...
  backIssue = () => {
    ...
    let url = tempurl.substring(0,tempurl.length-16);
  ...
  savaIssueMsg = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, data) => {
      ...
      if (!err) {
        ...
        let Issue=IssueManageStore.getIssueData;
        let parentCard = {}
        Issue.map((item)=>{
                ...
                <Row>
                  ...
                  <Col span={8}>
                    <FormItem label={HAP.languageChange('issue.ParentDemand')} {...workLoad}>
                      {getFieldDecorator('parentId',{initialValue:this.props.match.params.parentCardId})
                      (<AutoComplete
                          disabled={true}
                          style={{width: '100%'}}
                          dataSource={storyArr}
...
export default Form.create({})(withRouter(CreateSubCardPage));
